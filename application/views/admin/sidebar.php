<div class="left-sidebar-pro">
    <nav id="sidebar" class="">
        <div class="sidebar-header" style="margin-top:15px;">
            <a href="<?php echo base_url('admin/dashboard') ?>"><img class="main-logo" src="<?= base_url('assets/images'); ?>/icon2.png" alt="" /><span style="font-size: 16px;font-family: cursive; font-weight: bold;color: black;"> LAMARAJA</span></a>
            <strong><a href="<?php echo base_url('admin/dashboard') ?>"><img src="<?= base_url('assets/images'); ?>/icon2.png" alt="" /></a></strong>
        </div>
                ...
                <ul class="metismenu" id="menu1">
                    ...
                    <li>
                        ...
                        <ul class="submenu-angle" aria-expanded="false">
                            ...
                            <li><a title="Add Library" href="<?php echo base_url('admin/laporan/perusahaan') ?>"><span class="mini-sub-pro">Perusahaan</span></a></li>
                        </ul>
                    </li>
                </ul>
            </nav>
