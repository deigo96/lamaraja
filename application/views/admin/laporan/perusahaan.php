                            ...
                            <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th data-field="tLahir" data-editable="false">Telepon</th>
                                ...
                                <tbody>
                                    <?php foreach ($getData as $get) { ?> 
                                        <tr>
                                            <td></td>
                                            <td><?php echo $get->id_perusahaan ?></td>
                                            <td><?php echo $get->nama_perusahaan ?></td>
                                            <td><?php echo $get->email_login ?></td>
                                            <td><?php echo !empty($get->telepon_perusahaan) ? $get->telepon_perusahaan : "-" ?></td>
                                            <td>
                                                <img src="
                                                            <?php echo !empty($get->foto_perusahaan) ? base_url('assets/upload/perusahaan/').$get->foto_perusahaan : base_url('assets/images/profile_users/user.png') ?>    
                                                        " alt="" width="50px" style="height: 60px">
                                                
                                            </td>
                                            <td><?php echo $get->tanggal_daftar ?></td>
                                            <td>
                                                <?php
                                                    if($get->id_profile_perusahaan !== NULL){
