                    ...
                    <div class="ftco-search my-md-5">
                        <div class="row">
                            <div class="col-md-6 order-md-last offset-md-3">
                                <form action="#" id="login-form" class="p-5 contact-form" style="background: linear-gradient(to right, #207dff 0%, #a16ae8 100%)">
                                    ...
                                    <div class="form-group">
                                        <button type="submit" class="btn btn-primary btn-block py-3 px-5">Masuk</button>
                                    </div>
